...
class Course:
   def __init__(self, data: dict, policyParams: dict, specialCourses: set):
      ...
      #print(f"DEBUG: maxUnits={self.maxUnits}, enrollTotal={self.enrollTotal}")
   ...
   def calculateLoad(self) -> float:
      if self.enrollTotal == 0:
         self.load = 0.0
         #print(f"DEBUG: Zero enrollment: maxUnits={self.maxUnits}, enrollTotal={self.enrollTotal}")
         return self.load
      ...
      #print(f"DEBUG: Course load: maxUnits={self.maxUnits}, enrollTotal={self.enrollTotal}, baseRate={baseRate}, computedLoad={load}, extraLoad={extraLoad}, finalLoad={self.load}")
      return self.load
